...
Following kubectl helps you to identify what is the Container runtime your cluster is using (last column):

```sh
kubectl get nodes -o wide
NAME        STATUS   ROLES                  ...  CONTAINER-RUNTIME
nodename    Ready    control-plane,master   ...   docker://20.10.5
```
